        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.faq.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="question" id="question" class="form-control" value="{{ old('question') }}" required maxlength="500">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select name="target_role" id="target_role" class="form-control">
                        ...
                        <option value="customer" {{ old('target_role') == 'customer' ? 'selected' : '' }}>Customer</option>
                        <option value="restaurant" {{ old('target_role') == 'restaurant' ? 'selected' : '' }}>Restaurant</option>
                        <option value="delivery_partner" {{ old('target_role') == 'delivery_partner' ? 'selected' : '' }}>Delivery Partner</option>
