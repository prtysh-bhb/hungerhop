            ...
            <div class="col-md-12">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools">
                            <button type="button" class="btn btn-primary btn-sm" id="clearFilters">Clear All
                                Filters</button>
                            <a href="{{ route('restaurant.categories.create') }}"><button type="button"
                                    class="btn btn-primary btn-sm" id="addCategoryBtn">Add Categories</button></a>
                        </div>
                    </div>
                    <div class="box-body">
                        <form id="filterForm">
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                <div class="alert alert-info" id="filterResults" style="display: none;">
                                    <i class="fa fa-info-circle"></i> <span id="resultCount">0</span> categories found
            ...
            <table class="table border-no" id="example1">
                ...
                <tbody>
                    @foreach ($categories as $category)
                        <tr class="category-card" data-name="{{ strtolower($category->name) }}"
                            ...
                            <td>
                                <span
                                    class="badge {{ $category->is_active ? 'bg-success' : 'bg-secondary' }}">{{ $category->is_active ? 'Active' : 'Inactive' }}</span>
                            </td>
                            ...
                            <td>
                                ...
                                @if ($menuItemCount > 0)
                                    <button type="button" class="btn btn-sm btn-secondary" disabled
                                        ...
                                        title="Cannot delete: {{ $menuItemCount }} menu item(s) linked to this category">
                                        <i class="fa fa-lock me-1"></i>Delete
                                    </button>
                                    <small class="d-block text-muted mt-1">
                                        <i class="fa fa-info-circle"></i> {{ $menuItemCount }} menu item(s) linked
                                    </small>
                                @else
                                    <form action="{{ route('restaurant.categories.destroy', $category) }}" method="POST"
                                        class="d-inline" id="catDestroy{{ $category->id }}">
                                        @csrf
                                        @method('DELETE')
                                        <button form="catDestroy{{ $category->id }}" type="submit"
