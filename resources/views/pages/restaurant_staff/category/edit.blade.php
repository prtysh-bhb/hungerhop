    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="categoryForm" method="POST" action="{{ isset($category) ? route('restaurant.categories.update', $category->id) : route('restaurant.categories.store') }}" enctype="multipart/form-data">
                        @csrf
                        @if(isset($category))
                            @method('PUT')
                        @endif
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" readonly id="menu_template_id" name="menu_template_id" value="{{ old('menu_template_id', isset($category) ? $category->menu_template_id : 1) }}">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateNameField() {
        ...
        if (nameValue === '') {
            ...
            setFieldError(nameInput, 'Name should not contain numbers or special characters.');
            return false;
        } else {
