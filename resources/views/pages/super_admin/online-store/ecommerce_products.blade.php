...
<!-- Image Popup Plugin -->
<script src="{{ asset('assets/vendor_components/magnific-popup/dist/jquery.magnific-popup.min.js') }}"></script>
<script src="{{ asset('assets/vendor_components/magnific-popup/dist/jquery.magnific-popup-init.js') }}"></script>
<!-- Widget Charts JS -->
