                 ...
                 <div class="box">
                     ...
                     <div class="box-body">
                         <div
                             ...
                             <div>
                                 <div class="fs-18 fw-700">{{ $planLimits['name'] ?? $tenant->subscription_plan }} Plan
                                 </div>
                             ...
                             <div class="tab-content border rounded p-20 bg-white">
                                 ...
                                 <div class="tab-pane fade" id="upi" role="tabpanel">
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-6 col-md-3 mb-15">
                                             <div class="upi-option text-center p-15 border rounded cursor-pointer">
                                                 <i class="fa fa-mobile  text-success" style="font-size: 24px;"></i>
                                     ...
                                     <div class="row">
                                         <div class="col-6 col-md-4 mb-20">
                                             <div class="wallet-option text-center p-20 border rounded cursor-pointer"
                                                 data-wallet="paytm">
                                                 <i class="fa fa-credit-card text-primary" style="font-size: 32px;"></i>
                                         ...
                                         <div class="col-6 col-md-4 mb-20">
                                             <div class="wallet-option text-center p-20 border rounded cursor-pointer"
                                                 ...
                                                 <i class="fa fa-money text-success" style="font-size: 32px;"></i>
                                         ...
                                         <div class="col-6 col-md-4 mb-20">
                                             <div class="wallet-option text-center p-20 border rounded cursor-pointer"
                                                 ...
                                                 <i class="fa fa-mobile-phone text-warning" style="font-size: 32px;"></i>
