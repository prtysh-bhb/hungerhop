...
@section('scripts')
    ...
    <script>
        ...
        function updateDashboardStats() {
            fetch('{{ route('admin.dashboard.stats') }}')
                ...
                .then(data => {
                    ...
                    console.log('Location dashboard updated successfully at:', new Date().toLocaleTimeString());
                })
                .catch(error => {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('Location dashboard live updates enabled - will check for new orders every 5 seconds');
