				...
				<div class="col-xxxl-3 col-lg-6 col-12">
					<div class="box">
						<div class="box-body">
							<div class="d-flex align-items-start">
								<div>
									<img src="{{ asset('images/food/online-order-2.png') }}" class="w-80 me-20" alt="" />
								</div>
								<div>
				...
				<div class="col-xxxl-3 col-lg-6 col-12">
					<div class="box">
						<div class="box-body">
							<div class="d-flex align-items-start">
								<div>
									<img src="{{ asset('images/food/online-order-3.png') }}" class="w-80 me-20" alt="" />
								</div>
								<div>
				...
				<div class="col-xxxl-3 col-lg-6 col-12">
					<div class="box">
						<div class="box-body">
							<div class="d-flex align-items-start">
								<div>
									<img src="{{ asset('images/food/online-order-4.png') }}" class="w-80 me-20" alt="" />
								</div>
								<div>
										...
										<div class="d-flex align-items-center">
											<div class="review-tx">
												<div class="d-flex mb-10">
													<img src="{{ asset('images/avatar/1.jpg') }}" class="w-40 h-40 me-10 rounded100" alt="" />
													<div>
											...
											<img src="{{ asset('images/food/dish-1.png') }}" class="dish-img" alt="" />
										</div>
									</div>
								</div>
								<div class="box p-0">
									<div class="box-body">
										<div class="d-flex align-items-center">
											<div class="review-tx">
												<div class="d-flex mb-10">
													<img src="{{ asset('images/avatar/2.jpg') }}" class="w-40 h-40 me-10 rounded100" alt="" />
													<div>
											...
											<img src="{{ asset('images/food/dish-2.png') }}" class="dish-img" alt="" />
										</div>
									</div>
								</div>
								<div class="box p-0">
									<div class="box-body">
										<div class="d-flex align-items-center">
											<div class="review-tx">
												<div class="d-flex mb-10">
													<img src="{{ asset('images/avatar/3.jpg') }}" class="w-40 h-40 me-10 rounded100" alt="" />
													<div>
											...
											<img src="{{ asset('images/food/dish-3.png') }}" class="dish-img" alt="" />
										</div>
									</div>
								</div>
								<div class="box p-0">
									<div class="box-body">
										<div class="d-flex align-items-center">
											<div class="review-tx">
												<div class="d-flex mb-10">
													<img src="{{ asset('images/avatar/4.jpg') }}" class="w-40 h-40 me-10 rounded100" alt="" />
													<div>
											...
											<img src="{{ asset('images/food/dish-4.png') }}" class="dish-img" alt="" />
										</div>
									</div>
								</div>
								<div class="box p-0">
									<div class="box-body">
										<div class="d-flex align-items-center">
											<div class="review-tx">
												<div class="d-flex mb-10">
													<img src="{{ asset('images/avatar/5.jpg') }}" class="w-40 h-40 me-10 rounded100" alt="" />
													<div>
											...
											<img src="{{ asset('images/food/dish-5.png') }}" class="dish-img" alt="" />
										</div>
									</div>
								</div>
							</div>
												...
												<div class="media-list media-list-hover">
													<div class="media border-primary border-2">
														...
														<a class="avatar avatar-lg status-success mx-0" href="#">
															<img src="{{ asset('images/avatar/1.jpg') }}" class="bg-success-light" alt="...">
														</a>
													...
													<div class="media border-warning border-2">
														...
														<a class="avatar avatar-lg status-danger mx-0" href="#">
															<img src="{{ asset('images/avatar/2.jpg') }}" class="bg-warning-light" alt="...">
														</a>
														<div class="media-body">
															<p class="fs-16">
																<a class="hover-primary" href="#"><strong>Michal</strong></a>
															</p>
													...
													<div class="media border-info border-2">
														...
														<a class="avatar avatar-lg status-warning mx-0" href="#">
															<img src="{{ asset('images/avatar/3.jpg') }}" class="bg-info-light" alt="...">
														</a>
														<div class="media-body">
															<p class="fs-16">
													...
													<div class="media border-danger border-2">
														...
														<a class="avatar avatar-lg status-primary mx-0" href="#">
															<img src="{{ asset('images/avatar/4.jpg') }}" class="bg-danger-light" alt="...">
														</a>
														<div class="media-body">
															<p class="fs-16">
																<a class="hover-primary" href="#"><strong>Charlie</strong></a>
															</p>
													...
													<div class="media border-success border-2">
														...
														<a class="avatar avatar-lg status-success mx-0" href="#">
															<img src="{{ asset('images/avatar/5.jpg') }}" class="bg-success-light" alt="...">
														</a>
														<div class="media-body">
															<p class="fs-16">
																<a class="hover-primary" href="#"><strong>Jordan</strong></a>
															</p>
															<p class="text-muted">Designer</p>
														</div>
														<div class="media-right">
