                                ...
                                <tbody>
                                    @forelse($documents as $document)
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge badge-info">{{ ucwords(str_replace('_', ' ', $document->document_type)) }}</span>
                                            </td>
                                            <td>
                                                {{ $document->original_filename ?? 'N/A' }}
                                                @if ($document->file_size)
                                                    <br><small
                                                        class="text-muted">{{ number_format($document->file_size / 1024, 2) }}
                                                        KB</small>
                                                @endif
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                @if ($document->is_verified)
                                                    <span class="badge badge-success"><i class="fa fa-check"></i>
                                                        Verified</span>
                                                @else
                                                    <span class="badge badge-secondary"><i class="fa fa-clock-o"></i>
                                                        Unverified</span>
                                                @endif
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('restaurant-admin.documents.view', $document->id) }}"
                                                        class="btn btn-info btn-sm" title="View Document">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-warning"><strong>Warning:</strong> The document file will be permanently removed from
                        storage.</p>
                </div>
...
@push('scripts')
    <script>
        ...
        function deleteDocument(documentId) {
            $('#deleteForm').attr('action', '{{ route('restaurant-admin.documents.destroy', ':id') }}'.replace(':id',
                documentId));
