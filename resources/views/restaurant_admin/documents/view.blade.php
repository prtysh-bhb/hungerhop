                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools float-right">
                            ...
                            <a href="{{ route('restaurant-admin.documents.edit', $document->id) }}"
                                        ...
                                        <div class="card-body">
                                            @if ($document->reviewed_at)
                                                <div class="mb-3">
                                                    ...
                                                    {{ $document->reviewed_at->format('M d, Y h:i A') }}
                                                    @if ($document->reviewer)
                                                        <br><strong>Reviewed By:</strong>
                                                        {{ $document->reviewer->first_name }}
                                                        {{ $document->reviewer->last_name }}
                                                    @endif
                                                </div>
                                            @endif
                                            ...
                                            @if ($document->rejection_reason)
                                                <div class="mb-3">
                                                    ...
                                                    <p
                                                        class="mt-2 p-3 bg-danger-light border border-danger rounded text-danger">
                                    ...
                                    <div class="card-body text-center">
                                        @if (str_contains($document->mime_type, 'image/'))
                                            <img src="{{ asset('storage/' . $document->document_path) }}"
                                                alt="{{ $document->document_name }}" class="img-fluid rounded border"
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        ...
                                        <form method="POST"
                                            action="{{ route('restaurant-admin.documents.destroy', $document->id) }}"
