            ...
            <div class="col-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form action="{{ route('restaurant-admin.management.update', $restaurant->id) }}" method="POST"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="postal_code" name="postal_code"
                                            value="{{ old('postal_code', $restaurant->postal_code) }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" class="form-control" id="latitude"
                                            name="latitude" value="{{ old('latitude', $restaurant->latitude) }}"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" class="form-control" id="longitude"
                                            name="longitude" value="{{ old('longitude', $restaurant->longitude) }}"
                                            required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="delivery_radius_km">Delivery Radius (KM) <span
                                                class="text-danger">*</span></label>
                                        <input type="number" class="form-control" id="delivery_radius_km"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="base_delivery_fee">Base Delivery Fee <span
                                                class="text-danger">*</span></label>
                                        <input type="number" step="0.01" class="form-control" id="base_delivery_fee"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="business_hours" name="business_hours" rows="3"
                                            placeholder="e.g., Mon-Fri: 9:00 AM - 10:00 PM, Sat-Sun: 10:00 AM - 11:00 PM">{{ old('business_hours', is_string($restaurant->business_hours) ? $restaurant->business_hours : (is_array($restaurant->business_hours) ? json_encode($restaurant->business_hours) : '')) }}</textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if ($restaurant->cover_image_url)
                                            <div class="mt-2">
                                                ...
                                                <img src="{{ $restaurant->cover_image_url }}" alt="Current Cover Image"
                                                    class="img-thumbnail" style="max-width: 200px;">
                                            </div>
                                        @endif
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="accepts_orders"
                                            name="accepts_orders" value="1"
        ...
        $(document).ready(function() {
            ...
            $('#email').on('blur', function() {
                ...
                if (email && !emailPattern.test(email)) {
                    ...
                    if (!$(this).siblings('.invalid-feedback').length) {
                        $(this).after(
                            '<div class="invalid-feedback" style="display: block;">Please enter a valid email (e.g., user@gmail.com). Domain must start with a letter.</div>'
                            );
                    } else {
            ...
            $('form').on('submit', function(e) {
                ...
                if (!isValid) {
                    e.preventDefault();
                    alert(
                        'Please enter a valid email address. Domain must start with a letter (e.g., user@gmail.com).');
                }
            });
            ...
            $('input[type="file"]').on('change', function() {
                ...
                if (file) {
                    ...
                    reader.onload = function(e) {
                        if (preview.length === 0) {
                            preview = $(
                                '<div class="preview mt-2"><img class="img-thumbnail" style="max-width: 200px;"></div>'
                                );
                            $(this).after(preview);
                        }
