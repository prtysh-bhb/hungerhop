<header class="main-header">
    <div class="d-flex align-items-center logo-box justify-content-start">
        ...
        <!-- Logo -->
        <a href="{{ auth()->user()->role === 'location_admin' ? route('location-admin.dashboard') : route('admin.dashboard') }}"
            class="logo">
            <!-- logo-->
            <div class="logo-lg">
                {{-- <span class="light-logo"><img src="{{ asset('images/logo-dark-text_old.png') }}" alt="logo"></span> --}}
                {{-- <span class="light-logo"><img src="{{ asset('images/Hungerhop-1.png') }}" alt="logo" style="height: 75px; width: 125px;" ></span> --}}
                <span class="light-logo"><img src="{{ asset('images/Hungerhop-1.svg') }}" alt="logo"
                        style="height: 75px; width: 125px;"></span>
        ...
        <div class="navbar-custom-menu r-side">
            <ul class="nav navbar-nav">
                @if (auth()->user()->role === 'super_admin')
                    <!-- Wallet Transactions Button (Super Admin Only) -->
				<li class="btn-group nav-item d-lg-inline-flex d-none">
					<a href="{{ route('admin.wallet-transactions') }}"
						class="waves-effect waves-light nav-link full-screen btn-success" title="Wallet Transactions">
						<i class="ti-money fs-5"></i>
					</a>
				</li>
                @endif
                <li class="btn-group nav-item d-lg-inline-flex d-none">
                                ...
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            ...
                                            <img src="{{ asset('images/favicon.ico') }}" class="rounded-circle"
                                                alt="User Image">
                                        </div>
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle p-0 text-dark hover-primary ms-md-30 ms-10"
                        ...
                        <span class="ps-30 d-md-inline-block d-none">Hello,</span> <strong
                            class="d-md-inline-block d-none">{{ auth()->user()->name }}</strong><img
                            src="{{ asset('images/avatar/avatar-11.png') }}"
