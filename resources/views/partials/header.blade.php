	...
	<div class="d-flex align-items-center logo-box justify-content-start">
		...
		<a href="{{ 
		  ...
		  <div class="logo-lg">
				...
				<span class="light-logo"><img src="{{ asset('images/Hungerhop-1.svg') }}" alt="logo" style="height: 75px; width: 125px;" ></span>
		...
		<ul class="nav navbar-nav">	
				  ...
				  <li><!-- start message -->
					<a href="#">
					  <div class="pull-left">
						...
						<img src="{{ asset('images/favicon.ico') }}" class="rounded-circle" alt="User Image">
					  </div>
		  ...
		  <li class="dropdown user user-menu">
			<a href="#" class="dropdown-toggle p-0 text-dark hover-primary ms-md-30 ms-10" data-bs-toggle="dropdown" title="User">
				<span class="ps-30 d-md-inline-block d-none">Hello,</span> <strong class="d-md-inline-block d-none">{{ auth()->user()->name }}</strong><img src="{{ asset('images/avatar/avatar-11.png') }}" class="user-image rounded-circle avatar bg-white mx-10" alt="User Image">
			</a>
