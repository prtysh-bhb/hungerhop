...
// Initialize Perfect Scrollbar if element exists
var multiNavScrollElement = document.querySelector(".multinav-scroll");
if (multiNavScrollElement && typeof PerfectScrollbar !== "undefined") {
    try {
        new PerfectScrollbar(".multinav-scroll");
    } catch (error) {
        console.log("Perfect Scrollbar initialization failed:", error);
    }
}
